...
include(":testing:kafka-connect-testing")
...
include(":instrumentation:kafka:kafka-clients:kafka-clients-common-0.11:testing")
include(":instrumentation:kafka:kafka-connect-2.6:javaagent")
include(":instrumentation:kafka:kafka-connect-2.6:testing")
include(":instrumentation:kafka:kafka-streams-0.11:bootstrap")
